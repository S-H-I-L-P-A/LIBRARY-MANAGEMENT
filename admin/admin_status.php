...
<div class="container">
	...
	<?php
        ...
        ?>
        <form method="post">
        <button type="submit" name="submit1" style="background-color: #101010ed; color: red; font-weight: 700; font-size: 18px;" class="btn btn-deafault"><span style="color: red;" class="glyphicon glyphicon-remove-sign"></span>&nbsp Remove<span class="badge bg-green"></button>
        <button type="submit" name="submit2" style="background-color: #101010ed; color: green; font-weight: 700; font-size: 18px;" class="btn btn-deafault"><span style="color: green;" class="glyphicon glyphicon-ok-sign"></span>&nbsp Approve<span class="badge bg-green"></button>
        </form>
        <?php
		...
		echo "<table class='table table-bordered table-hover' >";
			...
			{
                $_SESSION['test name']=$row['username'];
				echo "<tr>";
